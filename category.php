...
<html lang="en">
	<head>
		...
		<link href="assets/css/green2.css" rel="alternate stylesheet" title="Green color">
...
<!-- ============================================== COLOR: END ============================================== -->
	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">	
			<div class="image">
				<img src="assets/images/banners/lap.jpg" alt="" class="img-responsive">
			</div>
...
while($row=mysql_fetch_array($sql))
{
    ?>
					...
					<div class="excerpt hidden-sm hidden-md" style="background: white;">
...
{?>							
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?pid=<?php echo htmlentities($row['id']);?>"><img  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['productName']);?>/<?php echo htmlentities($row['productImage1']);?>" alt="" width="200" height="250"></a>
			</div><!-- /.image -->			                      		   
		</div><!-- /.product-image -->
