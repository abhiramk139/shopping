...
// code for Shipping address updation
	if(isset($_POST['shipupdate']))
	{
		...
		$query=mysqli_query($bd,"update users set shippingAddress='$saddress',shippingState='$sstate',shippingCity='$scity',shippingPincode='$spincode' where id='$id'");
...
<html lang="en">
	<head>
		...
		<link href="assets/css/green2.ss" rel="alternate stylesheet" title="Green color">
